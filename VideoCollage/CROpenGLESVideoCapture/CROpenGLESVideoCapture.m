...
//    glBindRenderbuffer(GL_RENDERBUFFER, _originalRenderBuffer);
...
- (void)setupAssetWriter {
    ...
    if (UIInterfaceOrientationIsLandscape([[UIApplication sharedApplication] statusBarOrientation])) {
        videoWidth = [NSNumber numberWithInt:videoWidthInt];
        videoHeight = [NSNumber numberWithInt:videoHeightInt];
    } else {
        videoWidth = [NSNumber numberWithInt:videoHeightInt];
        videoHeight = [NSNumber numberWithInt:videoWidthInt];
    }
